...
export default function LicensesDropdown() {
  ...
  const columns = [
    { key: 'registrations', label: 'Registrations', icon: <FaFileAlt />, accent: '#1e6fd9' },
    { key: 'filings', label: 'Filings & Certificates', icon: <FaCertificate />, accent: '#4fc84a' },
  ];
