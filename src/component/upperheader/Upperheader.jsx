      ...
      <div className='max-w-7xl mx-auto flex flex-row justify-between items-center gap-3 md:gap-4'>
        ...
        <div className='flex items-center gap-3 md:gap-6'>
          ...
          <div className='flex items-center gap-2'>
            ...
            <a href="tel:+91-9548011256" className='text-xs md:text-sm hover:text-gray-300 transition-colors whitespace-nowrap'>
              +91-9548011256
            </a>
          </div>
          ...
          <div className='hidden md:flex items-center gap-2'>
            ...
            <a href="mailto:info@vectrataxprocompany.com" className='text-xs md:text-sm hover:text-gray-300 transition-colors whitespace-nowrap'>
